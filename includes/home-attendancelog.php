  ...
  while($dt1<=$dt2){
    ...
    $mnthtoday=date("m", strtotime($dt2));
      $formatted_date = date('Y-m-d', strtotime($dt2));
        ...
        obshbd as a 
        INNER JOIN employees as b ON a.EmpID=b.EmpID 
        INNER JOIN empdetails as d ON b.EmpID=d.EmpID where a.EmpID=:id and (OBStatus=1 or OBStatus=2 or OBStatus=4 or OBStatus=3 or OBStatus=5 or OBStatus=6) and OBDateFrom = '$formatted_date'
        ...
        hleavesbd as a 
        INNER JOIN employees as b ON a.EmpID=b.EmpID 
        INNER JOIN empdetails as d ON b.EmpID=d.EmpID where a.EmpID=:id and (LStatus=1 or LStatus=2 or LStatus=4 or LStatus=3 or LStatus=5 or LStatus=6) and a.LEnd = '$formatted_date'
