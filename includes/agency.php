        ...
        <div class="col-lg-3"></div>
         <!-- website content -->
          <div class="col-lg-9 module-content">
                          <h4 class="page-title" style="<?php echo "color: " . $_SESSION['CompanyColor']; ?>">Agency</h4>
             <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newform">+ Agency</button>
             <!-- The Modal -->
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body ob-body">
                        <form method="post"  class="frmagency">
                  <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label >No.:</label>
                          <input type="text" name="agencyno" id="agencyno" class="form-control" >
                        </div>  
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-6">
                          ...
                          <select class="form-control" name="agencystatus" id="agencystatus">
                           ...
                           <button type="button" required="required" class="btn btn-success btn-block btnagency">Submit</button>
                          </form>
                </div>
  ...
  <table class="table table-bordered">
    ...
    <thead>
      <tr>
        ...
        <th class="darth col-darth">Agency Name</th>
        <th class="darth  col-darth">Status</th>
