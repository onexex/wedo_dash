...
<head>
    <title>YTD 13th Month Report</title>
    <meta charset="utf-8">
    ...
    <!-- Print the report area in landscape.
         Hooks preserved: .btnprint #btngen1 #toprint .header_data .chk13_month .thisdate #cutOFd1 #cutOFd2 #reportview -->
    ...
    <style>
        /* Bootstrap-4 display utilities aren't in BS3 — the print handler toggles
           .d-none/.d-block on the report header, and the #chk13 checkbox column
           filter relies on show/hide (jQuery inline styles), so define these here
           (page-scoped, in <head> so they survive the document.body.innerHTML swap
           on print). */
...
<body>
    <?php $wd_active = 'generalreport'; include 'includes/wd-header.php'; ?>

    <div class="wd-pagehead">
        <div>
            <h1>YTD 13<sup>th</sup> Month Report</h1>
            <p>Year-to-date payroll totals per employee, with 13<sup>th</sup> month pay computed from basic and basic+allowance.</p>
        </div>
    </div>

    <section class="wd-card">
        <div class="wd-card__head">
            <h3>13<sup>th</sup> month summary</h3>
            <form style="display:flex;align-items:flex-end;gap:10px;flex-wrap:wrap;margin:0">
                ...
                <div class="wd-field" style="margin:0">
                    ...
                    <input type="date" class="wd-input" id="cutOFd2" name="cutOFd2" style="width:auto;padding:7px 10px">
                </div>
                <div class="wd-field" style="margin:0">
                ...
                <button class="wd-btn wd-btn--primary" id="btnView" type="button"><i class="fa-solid fa-eye"></i> View</button>
                <button class="wd-btn wd-btn--ghost btnprint" id="btngen1" type="button"><i class="fa-solid fa-print"></i> Print</button>
            </form>
        </div>
        ...
        <div class="wd-card__body">
            ...
            <div id="toprint">
                ...
                <div class="form-check chk13_month">
                    ...
                    <label class="form-check-label" for="chk13">Filter for 13 Month</label>
                </div>
